...
public class C01_NestedMaps {
    public static void main(String[] args) {
        ...
        /*
        eger bir elementle ile ilgili tutacagimiz bilgiler coksa veya complex ise
        bu defa ic ice map kullanmayi tercih edebiliriz

        ic ice map kullandigimizda daha fazla datayi daha duzenli olarak tutma imkanimşz olur
